...
import { SafeStorage, fetchProfile, fetchSpareParts, createSparePartOrder, getMySparePartOrders } from '../services/api';
        ...
        <View style={styles.orderCard}>
            <View style={styles.orderHeaderRow}>
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                    <View style={[styles.statusBadge, { backgroundColor: getStatusColor(item.status) + '20', marginRight: 10 }]}>
                        <Text style={[styles.statusText, { color: getStatusColor(item.status) }]}>{item.status}</Text>
                    </View>
                    <TouchableOpacity onPress={() => openOrderDetails(item)} style={styles.viewIconContainer}>
